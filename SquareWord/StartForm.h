...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->radioButtonNone->Text = L"Ñàìîñò³éíî";
			...
			this->radioButtonHide->Text = L"Â³äîáðàæåííÿ ò³ëüêè ïðàâèëüíèõ áóêâ";
			...
			this->radioButtonShow->Text = L"Ï³äñâ³÷óâàííÿ êîíôë³êòóþ÷èõ áóêâ";
